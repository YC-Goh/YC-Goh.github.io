...
export function useMDXComponents(components: MDXComponents): MDXComponents {
    return {
        h1: ({ children }) => (
            <StandardTitle margin_class="my-2" text_size_class="text-2xl sm:text-3xl" text_alignment_class="text-center" reference_class="mdx-title">
                { children }
            </StandardTitle>
        ), 
        h2: ({ children }) => (
            <StandardTitle margin_class="my-2" text_size_class="text-1xl sm:text-2xl" text_alignment_class="text-left" reference_class="mdx-subtitle">
                { children }
            </StandardTitle>
        ), 
        p: ({ children }) => (
