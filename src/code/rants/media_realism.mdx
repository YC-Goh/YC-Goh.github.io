...
-   The biggest tell that faggots are moving goalposts is this discussion pattern:
...
-   The usual rational response is this, but there's a reason it doesn't work for such cases:
    ...
    -   Reason it doesn't work is that faggots aren't actually sharing their opinion,
